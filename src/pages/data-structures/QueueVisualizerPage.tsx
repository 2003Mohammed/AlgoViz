...
const QueueVisualizerPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-background p-2 sm:p-4 md:p-8">
      <div className="max-w-7xl mx-auto space-y-6 md:space-y-8">
        ...
        >
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold gradient-text">Queue Data Structure</h1>
          <p className="text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl mx-auto px-4">
            Understand FIFO (First In First Out) operations through interactive queue visualization
          </p>
        </motion.div>
