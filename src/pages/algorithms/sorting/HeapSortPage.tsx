    ...
    <div className="min-h-screen bg-background p-2 sm:p-4 md:p-8">
      <div className="max-w-7xl mx-auto space-y-6 md:space-y-8">
        ...
        >
          ...
          <span>Sorting</span>
          <span>/</span>
          <span className="text-foreground">Heap Sort</span>
        </motion.div>
        ...
        >
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold gradient-text">Heap Sort Algorithm</h1>
          <p className="text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl mx-auto px-4">
            See how binary heap data structure is used to achieve efficient in-place sorting
          </p>
        </motion.div>
