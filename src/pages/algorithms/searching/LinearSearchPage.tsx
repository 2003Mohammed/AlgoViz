    ...
    <div className="min-h-screen bg-background p-2 sm:p-4 md:p-8">
      <div className="max-w-7xl mx-auto space-y-6 md:space-y-8">
        ...
        >
          ...
          <span>Searching</span>
          <span>/</span>
          <span className="text-foreground">Linear Search</span>
        </motion.div>
        ...
        >
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold gradient-text">Linear Search Algorithm</h1>
          <p className="text-muted-foreground text-sm sm:text-base md:text-lg max-w-2xl mx-auto px-4">
            Watch how elements are checked sequentially from start to end to find the target
          </p>
        </motion.div>
